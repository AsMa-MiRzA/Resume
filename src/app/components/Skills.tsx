  ...
  return (
    ...
    >
      <div className=" px-10 mt-32 mx-auto">
        ...
        <h1 className='font-autograph text-white text-center text-4xl font-bold mb-10 '>Skills</h1>
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-4 gap-20">
          {/* skill 1 */}
          <div className=" p-5 ">
            <img
